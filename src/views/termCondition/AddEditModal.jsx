...
const TermConditionFormModal = memo(({ open, mode, data, onSubmit, onClose }) => {
        ...
        <form onSubmit={handleSubmit} style={formContainerStyle}>
          ...
          <div style={footerStyle}>
            ...
            <button type="submit" style={primaryBtnStyle}>
              {mode === "edit" ? "Update Term & Condition" : "Save Term & Condition"}
            </button>
          </div>
        </form>
      </div>
...
export default TermConditionFormModal;
