...
} from "../../features/aboutUsApi.js";
import ConfirmModal from "../../components/modal/ConfirmModal";
import ViewUserModal from "./ViewUserModal";
import AboutUSFormModal from "./AddEditModal";
...
export default function Index() {
  ...
  const [editAboutUs] = useEditAboutUsMutation();
   ...
   const handleFormSubmit = async (payload) => {
    try {
      if (mode === "add") {
        ...
        await addAboutUs({ data: payload }).unwrap();
  ...
  const handleDelete = useCallback(async () => {
    ...
    try {
      await deleteAboutUs(selectedId).unwrap();
