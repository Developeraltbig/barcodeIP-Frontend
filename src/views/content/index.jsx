...
export default function Index() {
  ...
  // API Mutations
  const [addUserSpecification] =   useAddContentMutation();
  const [editUserSpecification] = useEditContentMutation();
  const [deleteUser] = useDeleteContentMutation();
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h2 style={styles.title}>Landing Page Content</h2>
        <button 
          style={styles.addBtn} 
          onClick={handleAdd}
