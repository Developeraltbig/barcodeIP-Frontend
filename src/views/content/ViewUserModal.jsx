  ...
  return ReactDOM.createPortal(
    <div style={overlayStyle} onClick={onClose}>
      ...
      <div style={cardStyle} onClick={(e) => e.stopPropagation()}>
        <h3 style={headerStyle}>Specification User Details</h3>
        
        <div style={contentStyle}>
          <DataRow label="Email Address" value={data.email} />
          <DataRow label="First Name" value={data.first_name} />
          <DataRow label="Last Name" value={data.last_name} />
          <DataRow label="Gender" value={data.gender} />
          <DataRow label="Age" value={data.age} />
          <DataRow label="Message Field" value={data.message_field} />
          <DataRow label="Platform" value={data.platform} />
          <DataRow label="status" value={data.status} />
          <DataRow label="Activated" value={data.activated} />
          <DataRow label="Last LoggedIn" value={data.last_loggedin} />
          <DataRow label="Date of Birth" value={data.dob} />
          <DataRow label="User Type" value={data.userType} />
