...
import {
  ...
  useAddAdminUserMutation,    // Added
  useEditAdminUserMutation,   // Added
} from "../../features/adminUserApi.js";
...
export default function Index() {
  ...
  const [editAdmin] = useEditAdminUserMutation();
    ...
    <div style={styles.container}>
      ...
      <DataTable
        ...
        columns={[
          ...
          { label: "Sign In Count", accessor: "signInCount" },
        ]}
        data={users}
        onView={handleView}
        onEdit={handleEdit}
